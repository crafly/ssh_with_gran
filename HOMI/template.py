...
\\begin{figure}[!htbp]
    ...
    import os
    curdir=os.getcwd()
    os.system("cd /tmp; rm *.pdf *.eps *.ps *.tif; pdflatex a.tex; pdfcrop a.pdf; mv a-crop.pdf a.pdf; pdf2ps a.pdf; ps2eps a.ps; mogrify -density 2000 -format tif -compress lzw a.eps; mv a.tif \""+ curdir +"\"  > /dev/null 2>&1")
